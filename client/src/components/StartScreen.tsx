  ...
  return (
    <div className="relative flex flex-col min-h-screen text-white bg-black">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-32 h-32 bg-red-500 rounded-full opacity-75 animate-neon-pulse blur-3xl"
             style={{top: '10%', left: '20%'}}></div>
        <div className="absolute w-48 h-48 bg-green-500 rounded-full opacity-75 animate-neon-pulse blur-3xl"
             style={{top: '50%', left: '70%'}}></div>
        <div className="absolute w-24 h-24 bg-blue-500 rounded-full opacity-75 animate-neon-pulse blur-3xl"
             style={{top: '70%', left: '30%'}}></div>
        <div className="absolute w-24 h-24 bg-yellow-500 rounded-full opacity-75 animate-neon-pulse blur-3xl"
